...
namespace rz {
namespace config {
constexpr std::string_view PROJECT_NAME = "CPP_Template";
constexpr std::string_view PROG_LONGNAME = "C++23 Template with CMake and CI";
constexpr std::string_view PROJECT_DESCRIPTION = "CPP Template";

constexpr std::string_view EXECUTABLE_NAME = "CPP_Template";
...
constexpr std::string_view PROJECT_HOMEPAGE_URL = "https://github.com/Zheng-Bote/cpp_template";
